    ...
    createViewData(){
        this.viewData = [
            ...
            },
            {
                ...
                text: this.userValue ? "" : "为了避免误机，建议提前至少3小时到达机场",
                field:"time",
                onPress: (data) => {
                        ...
                        <BottomItemView
                            ...
                            cb={() => {
                                navigation.push(this, "QueryCharterNext", {
                                    ...
                                    values: {
                                        time:this.userValue,
                                        headValue:this.startPlace,
                                        userCarType:"送机",
                                        endPlace:this.endAirport
                                    },
